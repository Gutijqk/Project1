...
public class GiangVienGUI extends javax.swing.JPanel {
    ...
    public GiangVienGUI() throws Exception {
        initComponents();
        loadListLecture();
    }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            ...
            try {
                if (LectureBUS.deleteLectureById(id)) {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try {
            if (LectureBUS.updateLectureByID(id, lecture)) {
...
//        ArrayList<Lecture> listLectureSearch = new ArrayList();
//        for (Lecture lec : listLecture) {
//            if (lec.getFirstName().contains(keyWordSearch) || lec.getLastName().contains(keyWordSearch)) {
//                listLectureSearch.add(lec);
//            }
//        }
//        try {
//            loadListLectureSearch(listLectureSearch);
//        } catch (Exception ex) {
//            Logger.getLogger(GiangVienGUI.class.getName()).log(Level.SEVERE, null, ex);
//        }

        try {
            ArrayList<Lecture> listLecture = LectureBUS.searchByName(keyWordSearch);
    ...
    private void loadListLecture() throws Exception {
        listLecture = LectureBUS.getAllLecture();
        ...
        for (Lecture lecture : listLecture) {
            ...
            vec.add(lecture.getDateTime().toString());
            i++;
            model.addRow(vec);
        }
